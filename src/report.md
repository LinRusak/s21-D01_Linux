...
![установка Ubuntu](/mnt/d/Repos/D01_Linux-1/src/Part 1/Part1.png)

## Part 2. Создание пользователя
**== Задание ==**
##### Создай пользователя, отличного от созданного при установке. Пользователь должен быть добавлен в группу `adm`.
- Вставь скриншот вызова команды для создания пользователя.  
![создание пользователя](/mnt/d/Repos/D01_Linux-1/src/Part 2/Part2-1.png)
- Добавление в группу ADM
![создание пользователя](/mnt/d/Repos/D01_Linux-1/src/Part 2/Part2-3.png)
- Новый пользователь должен быть в выводе команды \
`cat /etc/passwd`  Вставь скриншот с выводом команды.  
![вывод команды passwd](/mnt/d/Repos/D01_Linux-1/src/Part 2/Part2-2.png)

## Part 3. Настройка сети ОС
**== Задание ==**

##### Задай название машины вида user-1.
![название машины](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-1.png)
##### Установи временную зону, соответствующую твоему текущему местоположению. 
![change time](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-2.png) 
##### Выведи названия сетевых интерфейсов с помощью консольной команды.
![сетевые интерфейсы](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-3.png) 
- В отчёте дай объяснение наличию интерфейса lo.  
lo (loopback device) – виртуальный интерфейс, присутствующий по умолчанию в любом Linux. Он используется для отладки сетевых программ и запуска серверных приложений на локальной машине. С этим интерфейсом всегда связан адрес 127.0.0.1. У него есть dns-имя – localhost. Посмотреть привязку можно в файле /etc/hosts.
##### Используя консольную команду, получи ip адрес устройства, на котором ты работаешь, от DHCP сервера. 
![ip adress](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-4.png)
...
![адреса и шлюз](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-5.png)
##### Задай статичные (заданные вручную, а не полученные от DHCP сервера) настройки ip, gw, dns (используй публичный DNS серверы, например 1.1.1.1 или 8.8.8.8).  
![статичный ip](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-6.png)
##### Перезагрузи виртуальную машину. Убедись, что статичные сетевые настройки (ip, gw, dns) соответствуют заданным в предыдущем пункте.  
![reboot](/mnt/d/Repos/D01_Linux-1/src/Part 3/Part3-6.png)
